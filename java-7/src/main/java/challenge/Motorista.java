...
public class Motorista {
    ...
    private Motorista(String nome, int idade, int pontos, String habilitacao) {
        if (nome.isEmpty()) throw new NullPointerException("Motorista deve declarar um nome.");
        if (habilitacao.isEmpty()) throw new NullPointerException("Motorista deve possuir uma habilitação.");
        this.nome = nome;
        this.idade = idade;
        this.pontos = pontos;
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
            if (idade < 0) throw new IllegalArgumentException("A idade não deve ser negativa.");
            this.idade = idade;
            return this;
        }

        public MotoristaBuilder withPontos(int pontos) {
            if (pontos < 0) throw new IllegalArgumentException("Os pontos não devem ser negativos.");
            this.pontos = pontos;
            return this;
        }
