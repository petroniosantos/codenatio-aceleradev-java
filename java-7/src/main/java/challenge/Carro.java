...
public class Carro {
    ...
    private Carro(Motorista motorista, String placa, Cor cor) {
        validaCampos(motorista, placa, cor);
    ...
    private void validaCampos(Motorista motorista, String placa, Cor cor){
        if (cor == null) throw new NullPointerException("O carro deve ter uma cor.");
        if (placa == null) throw new NullPointerException("O carro deve ter uma placa.");
